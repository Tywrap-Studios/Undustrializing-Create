...
public class ModItems {
    ...
    public static final Item IRON_POWDER = registerItem("coal_powder", new Item(new FabricItemSettings()));
    //ingots
    public static final Item PIG_IRON_INGOT = registerItem("pig_iron_ingot", new Item(new FabricItemSettings()));
    public static final Item STEEL_INGOT = registerItem("coal_powder", new Item(new FabricItemSettings()));
    ...
    //rotors
    public static final Item ALUMINIUM_ROTOR = registerItem("aluminium_rotor", new Item(new FabricItemSettings()));
    public static final Item HIGH_PRESSURE_ALUMINIUM_ROTOR = registerItem("aluminium_rotor", new Item(new FabricItemSettings()));
    //inerts
    ...
    //filters
    public static final Item FLUID_FILTER = registerItem("electrode_pair", new Item(new FabricItemSettings()));
